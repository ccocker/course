...
@Component({
  ...
  templateUrl: './course-schedule-tutors.component.html',
  styleUrl: './course-schedule-tutors.component.scss',
})
export class CourseScheduleTutorsComponent implements OnInit, OnDestroy {
