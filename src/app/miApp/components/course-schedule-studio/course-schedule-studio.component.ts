...
@Component({
  ...
  templateUrl: './course-schedule-studio.component.html',
  styleUrl: './course-schedule-studio.component.scss',
})
export class CourseScheduleStudioComponent implements OnInit, OnDestroy {
