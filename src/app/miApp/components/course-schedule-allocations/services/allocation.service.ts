...
export class AllocationService {
  ...
  private getPreAllocations(): Allocation[] {
    ...
    allocations.push(
      ...
      {
        userId: 'soham.mandal@rmit.edu.au',
        classCode: 'BC1-G1-2',
        priority: 'H',
      },
      {
      ...
      {
        userId: 'snigdha.mathur@rmit.edu.au',
        classCode: 'BC1-G2-1',
        priority: 'H',
      },
      {
      ...
      {
        userId: 'dale.stanbrough@rmit.edu.au',
        classCode: 'BC1-G3-1',
        priority: 'H',
      },
      {
